...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Dialog->resize(694, 469);
        Dialog->setStyleSheet(QLatin1String("/* Basic Palette\n"
...
""));
        ...
        buttonBox->setGeometry(QRect(330, 420, 341, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        listView_textures = new QListView(Dialog);
        listView_textures->setObjectName(QStringLiteral("listView_textures"));
        listView_textures->setGeometry(QRect(10, 10, 271, 411));
        label_texture = new QLabel(Dialog);
        label_texture->setObjectName(QStringLiteral("label_texture"));
        label_texture->setGeometry(QRect(390, 30, 256, 256));
